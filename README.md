...
- Comparé tiendas según:
  - Sus ingresos totales
  - Categorías más y menos vendidas
  - Calificación promedio de los clientes
  - Costos de envío

Todo el análisis fue hecho paso a paso con ayuda y explicaciones para poder entender cómo funciona.
...
- **Google Colab** (para escribir y ejecutar el código)
- **Python**
- Algunas librerías como:
  - `matplotlib.pyplot` para crear los gráficos
...
- **Tienda 4** tiene el costo de envío más bajo, pero también los ingresos más bajos.
- La categoría **"Muebles"** fue la más vendida en todas las tiendas.

---

## ✅ Conclusión

Después de analizar los datos, la **Tienda 4 es la que se recomienda vender**, ya que tiene el menor rendimiento general.
